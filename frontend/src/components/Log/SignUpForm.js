    ...
    return (
        <>
            {formSubmit ? ( 
                <>
                <Signinform />
                <h4 className='success'> Compte créé avec succès! Veuillez vous connecter</h4>
                </>
            ) : ( 
        <form action='' onSubmit={handleRegister} id='signup-form'>
            ...
            <br/>
            <input type="password" name="password" id="confirm-password" onChange={(e) => setControlPassword(e.target.value)} value={controlPassword} />
            <div className='confPasswordError'></div>
            <br/>
            <input type="checkbox" id="condition" />
            <label htmlFor='condition'>{' '}J'accepte les <a href="/" target="_blank" rel='noopener noreferrer'>Conditions Gérérales</a></label>
